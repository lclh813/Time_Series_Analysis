...
- If AIC and BIC suggest different lag orders, the model with the smallest ***BIC*** should be considered as the the optimal because BIC is a ***consistent model selection*** criterion while AIC is not.
