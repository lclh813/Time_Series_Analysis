...
- A series with ***nonconstant variance*** often needs a ***logarithmic transformations*** and to ```Box-Cox’s power transformation``` can be applied to stabilize the variance. 
